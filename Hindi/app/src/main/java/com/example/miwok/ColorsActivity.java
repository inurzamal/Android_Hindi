...
public class ColorsActivity extends AppCompatActivity {
     ...
     * global variable of type MediaPlayer class that can hold object of MediaPlayer*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                //Play audio if we get the AudioFocus request granted
    ...
    /**
     * To stop the MediaPlayer and release resources immediately after leaving the activity
     * or screen lock or minimize the app
     */
    @Override
